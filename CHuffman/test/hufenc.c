...
size_t* countCharFreq(char *filename) {

	size_t* freq=(size_t*)calloc(FREQ_MAX,sizeof(*freq));
	FILE *fin;
...
void printCharFreq(size_t *freq) {
	size_t tf=0;
	int i;
...
int main(int argc,char **argv) {
	...
	char** table=(char**)malloc(sizeof(*table)*TABLE_MAX);
	PQ_Node* pq=NULL;
